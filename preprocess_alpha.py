...
for action in actions_alpha:
    for sequence in range(no_sequences):
        ...
        for frame_num in range(sequence_length):
            ...
            window.append(res)
            rotatedpos_window, rotatedneg_window, flipped_window,translated_window = data_aug.augment_landmarks(res, rotatedneg_window, rotatedpos_window, flipped_window,translated_window)
