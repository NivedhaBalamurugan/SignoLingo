...
for action in actions_alpha:
    for sequence in range(no_sequences):
        ...
        for frame_num in range(sequence_length):
            ...
            if res.shape != (21,3):
                print(action," ",sequence," ", frame_num," " ,res.shape)
            window.append(res)
...
X_alpha_train, X_alpha_test, y_alpha_train, y_alpha_test = train_test_split(X_alpha, y_alpha, test_size=0.05)
...
X_dig_train, X_dig_test, y_dig_train, y_dig_test = train_test_split(X_dig, y_dig, test_size=0.05)
